...
const yearsList: YearCard[] = [
  { id: '1', yearName: 'First Year', code: 'Year 1', description: 'Basic electronics, electric circuits, engineering mathematics, and fundamental science.' },
  { id: '2', yearName: 'Second Year', code: 'Year 2', description: 'Analog & digital electronics, microcontrollers, signal processing, and communication principles.' },
  { id: '3', yearName: 'Third Year', code: 'Year 3', description: 'Embedded systems, VLSI design, wireless communications, and industrial electronics.' },
];

export function EcPage({ onBack, onSelectYear }: EcPageProps) {
  ...
  // Year 1 နှိပ်ပါက EcYear1 ပြသမည်
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <div>
        ...
        <header className="results-header" style={{ width: '100%', borderRadius: 0, margin: 0, padding: '2rem 1rem' }}>
          <div className="results-header-inner" style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
            ...
            <h2>Electronic Engineering (EC) Results</h2>
      ...
      <footer className="results-footer" style={{ width: '100%', borderRadius: 0, margin: 0, marginTop: '3rem' }}>
        ...
        <p className="footer-sub">Electronic Engineering Department - Academic Tracking</p>
      </footer>
