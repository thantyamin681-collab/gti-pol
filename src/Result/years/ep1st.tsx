...
const studentResults: StudentResult[] = [
  ...
  { no: 3, rollNo: '1GEP-3', name: 'မောင်လားမွန့်‌မော', marks: ['B+', 'A-', 'A', 'A', 'A-', 'A-', 'A-', 'A'] },
  { no: 4, rollNo: '1GEP-27', name: 'မအေးသဇင်နှင်း', marks: ['A-', 'A-', 'A', 'A-', 'A-', 'A', 'A-', 'A-'] },
  { no: 5, rollNo: '1GEP-24', name: 'မနှင်းအိအိခင်', marks: ['A-', 'B+', 'B+', 'B+', 'A-', 'A', 'A', 'A'] },
  { no: 6, rollNo: '1GEP-8', name: 'မဆုမြတ်နိုး', marks: ['B+', 'A-', 'A', 'A-', 'A-', 'A', 'B+', 'A'] },
  ...
  { no: 11, rollNo: '1GEP-9', name: 'မောင်လွင်မိုးအောင်', marks: ['B+', 'B+', 'A-', 'A-', 'A-', 'A-', 'B+', 'B+'] },
  ...
  { no: 15, rollNo: '1GEP-18', name: 'မောင်အောင်ခန့်မွန်', marks: ['B+', 'B+', 'A-', 'B+', 'B+', 'A-', 'B+', 'B+'] },
  ...
  { no: 18, rollNo: '1GEP-7', name: 'မောင်လရောင်ခ', marks: ['B+', 'B+', 'A-', 'Inc', 'A-', 'A', 'A', 'B+'] },
  ...
  { no: 23, rollNo: '1GEP-11', name: 'မသွန်းရတီဦး', marks: ['B+', 'B+', 'A-', 'B+', 'Inc', 'B-', 'D', 'Inc'] },
