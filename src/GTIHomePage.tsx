...
ကျောင်းတွင် တက္ကသိုလ်ဝင်စာမေးပွဲ အောင်မြင်ပြီးသူများအတွက် (၃) နှစ်တက်ရောက်ရသော A.G.T.I. ဒီပလိုမာသင်တန်းများ ဖြစ်သည့် -
မြို့ပြအင်ဂျင်နီယာ (Civil)
အီလက်ထရွန်နစ်အင်ဂျင်နီယာ (EC)
လျှပ်စစ်စွမ်းအားအင်ဂျင်နီယာ (EP)
စက်မှုအင်ဂျင်နီယာ (MP)
သတင်းအချက်အလက်နည်းပညာ (IT)
စသည့် အဓိကဘာသာရပ်များကို လက်တွေ့နှင့် စာတွေ့ စနစ်တကျ သင်ကြားလေ့ကျင့်ပေးလျက်ရှိပါသည်။
                </p>
              </div>
            </div>
          </section>
