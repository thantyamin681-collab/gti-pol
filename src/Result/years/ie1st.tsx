...
const studentResults: StudentResult[] = [
  ...
  { no: 5, rollNo: '1GIE-5', name: 'မချမ်းမြြို့မြို့ရွှေ', marks: ['B', 'A-', 'A-', 'B+', 'A-', 'A', 'A', 'A'] },
  { no: 6, rollNo: '1GIE-20', name: 'မတွယ်တာစိုးထက်', marks: ['B', 'B+', 'A', 'B+', 'A-', 'A-', 'A', 'A'] },
  { no: 7, rollNo: '1GIE-3', name: 'မစန်းသီရိဇော်', marks: ['B+', 'B+', 'A', 'B+', 'A-', 'A', 'B+', 'A'] },
  { no: 8, rollNo: '1GIE-10', name: 'မရိုဇ်လင်းစိုးပိုင်', marks: ['A-', 'B+', 'A-', 'A-', 'A-', 'A-', 'A-', 'A-'] },
  ...
  { no: 15, rollNo: '1GIE-19', name: 'မဆုမွန့်ပြည့်', marks: ['B+', 'B+', 'A', 'B', 'B+', 'A-', 'B+', 'A-'] },
