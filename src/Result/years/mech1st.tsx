...
const studentResults: StudentResult[] = [
  { no: 1, rollNo: '1GMech-26', name: 'မောင်စိုင်းနဒီ', marks: ['A-', 'A-', 'A+', 'A', 'A', 'A+', 'A-', 'A+'] },
  { no: 2, rollNo: '1GMech-7', name: 'မအိအိသူ', marks: ['A-', 'B+', 'A', 'A', 'A', 'A', 'A-', 'A'] },
  { no: 3, rollNo: '1GMech-3', name: 'မောင်ပြည့်ဘုန်းမောင်', marks: ['A-', 'B', 'A', 'A', 'A', 'A', 'A-', 'A'] },
  { no: 4, rollNo: '1GMech-8', name: 'မောင်ရဲနိုင်ဝင်း', marks: ['A-', 'B+', 'A', 'A-', 'A', 'A-', 'A', 'A'] },
  { no: 5, rollNo: '1GMech-18', name: 'မောင်အောင်ဟိန်းကျော်', marks: ['B', 'B+', 'A', 'A-', 'A-', 'A-', 'A-', 'A'] },
  { no: 6, rollNo: '1GMech-25', name: 'မောင်ရွှေဘုန်းအောင်', marks: ['B+', 'B', 'B+', 'B+', 'A', 'A-', 'A', 'A-'] },
  { no: 7, rollNo: '1GMech-6', name: 'မောင်‌‌‌‌ဝေဖြိုးထက်', marks: ['B+', 'A-', 'A', 'B+', 'B+', 'A-', 'A-', 'A-'] },
  { no: 8, rollNo: '1GMech-22', name: 'မရွှေဝတ်မှုံ', marks: ['B+', 'B+', 'A-', 'B+', 'B+', 'A-', 'A-', 'A'] },
  { no: 9, rollNo: '1GMech-13', name: 'မောင်မင်းသုတစိုး', marks: ['B+', 'A-', 'A-', 'B+', 'A-', 'A-', 'A-', 'B+'] },
  { no: 10, rollNo: '1GMech-24', name: 'မောင်သက်ထွန်းအောင်', marks: ['B+', 'B+', 'A-', 'B+', 'A-', 'A-', 'B', 'A-'] },
  { no: 11, rollNo: '1GMech-1', name: 'မောင်ဟိန်းထက်အောင်', marks: ['B+', 'A-', 'A-', 'D', 'B+', 'B+', 'B', 'A-'] },
  { no: 12, rollNo: '1GMech-9', name: 'မောင်ဖြိုးသီဟကျော်', marks: ['B+', 'B-', 'A-', 'B', 'B-', 'A-', 'C', 'A-'] },
  { no: 13, rollNo: '1GMech-4', name: 'မောင်ပြည့်ဖြိုးဦး', marks: ['B+', 'B-', 'A-', 'C', 'B+', 'B+', 'D', 'A-'] },
  { no: 14, rollNo: '1GMech-20', name: 'မောင်ညီညီအောင်', marks: ['B+', 'B+', 'A-', 'B', 'D', 'B+', 'D', 'A-'] },
  { no: 15, rollNo: '1GMech-14', name: 'မောင်ပြေဇော်ထက်', marks: ['B+', 'A-', 'A-', 'A-', 'Inc', 'A', 'A-', 'A'] },
  { no: 16, rollNo: '1GMech-2', name: 'မောင်စောထူးဝါး', marks: ['B', 'A-', 'A-', 'Inc', 'B+', 'A', 'A', 'A'] },
  { no: 17, rollNo: '1GMech-16', name: 'မောင်ပြည့်အောင်ခန့်', marks: ['B+', 'A-', 'B+', 'B+', 'Inc', 'A-', 'B+', 'A-'] },
  ...
  { no: 21, rollNo: '1GMech-19', name: 'မချယ်ရီသိမ့်', marks: ['B+', 'B+', 'B+', 'Inc', 'Inc', 'B+', 'B+', 'A-'] },
  { no: 22, rollNo: '1GMech-23', name: 'မောင်ဝေယံမိုးအောင်', marks: ['B+', 'B+', 'Inc', 'B', 'C', 'A-', 'D', 'A'] },
  { no: 23, rollNo: '1GMech-10', name: 'မောင်လင်းလက်ဥက္ကာမောင်', marks: ['B-', 'D', 'B+', 'Inc', 'Inc', 'B+', 'B-', 'A-'] },
  { no: 24, rollNo: '1GMech-5', name: 'မောင်ထက်ဝေယံဦး', marks: ['C', 'B', 'B+', 'Inc', 'Inc', 'B-', 'D', 'B+'] },
  { no: 25, rollNo: '1GMech-31', name: 'မောင်စိုင်းဆိုင်မောက်', marks: ['B+', 'Inc', 'Inc', 'B+', 'Inc', 'Inc', 'A-', 'B+'] },
