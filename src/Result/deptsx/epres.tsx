...
const yearsList: YearCard[] = [
  { id: '1', yearName: 'First Year', code: 'Year 1', description: 'Fundamental electrical circuits, physics, basic engineering, and mathematics.' },
  { id: '2', yearName: 'Second Year', code: 'Year 2', description: 'Electrical machines, AC/DC circuits, electromagnetic theory, and instrumentation.' },
  { id: '3', yearName: 'Third Year', code: 'Year 3', description: 'Power generation, distribution, high voltage engineering, and smart grids.' },
];

export function EpPage({ onBack, onSelectYear }: EpPageProps) {
  ...
  // // Year 1 နှိပ်ပါက EpYear1 ပြသမည်
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <div>
        ...
        <header className="results-header" style={{ width: '100%', borderRadius: 0, margin: 0, padding: '2rem 1rem' }}>
          <div className="results-header-inner" style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
            ...
            <h2>Electrical Power (EP) Results</h2>
      ...
      <footer className="results-footer" style={{ width: '100%', borderRadius: 0, margin: 0, marginTop: '3rem' }}>
        ...
        <p className="footer-sub">Electrical Power Department - Academic Tracking</p>
      </footer>
