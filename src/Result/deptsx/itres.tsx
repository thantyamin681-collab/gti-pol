...
import { ItYear1 } from '../years/it1st';
import { ItYear2 } from '../years/it2nd';
import { ItYear3 } from '../years/it3rd';
...
const yearsList: YearCard[] = [
  { id: '1', yearName: 'First Year', code: 'Year 1', description: 'Fundamental programming, mathematics, and basic computer engineering.' },
  { id: '2', yearName: 'Second Year', code: 'Year 2', description: 'Data structures, object-oriented programming, and computer networks.' },
  { id: '3', yearName: 'Third Year', code: 'Year 3', description: 'Advanced software engineering, database systems, and web technologies.' },
];

export function ItPage({ onBack, onSelectYear }: ItPageProps) {
  ...
  // Year 1 နှိပ်ပါက ItYear1 ပြသမည်
  if (selectedYear === 'Year 1') {
    return <ItYear1 onBack={() => setSelectedYear(null)} />;
  }

  // Year 2 နှိပ်ပါက ItYear2 ပြသမည်
  if (selectedYear === 'Year 2') {
    return <ItYear2 onBack={() => setSelectedYear(null)} />;
  }

  // Year 3 နှိပ်ပါက ItYear3 ပြသမည်
  if (selectedYear === 'Year 3') {
    return <ItYear3 onBack={() => setSelectedYear(null)} />;
  }
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <div>
        ...
        <header className="results-header" style={{ width: '100%', borderRadius: 0, margin: 0, padding: '2rem 1rem' }}>
          <div className="results-header-inner" style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
            ...
            <h2>Information Technology (IT) Results</h2>
      ...
      <footer className="results-footer" style={{ width: '100%', borderRadius: 0, margin: 0, marginTop: '3rem' }}>
        ...
        <p className="footer-sub">Information Technology Department - Academic Tracking</p>
      </footer>
