...
const studentResults: StudentResult[] = [
  ...
  { no: 6, rollNo: '1GATM-9', name: 'မောင်ခန့်ပြည့်ဖြိုး', marks: ['B+', 'B+', 'A-', 'A-', 'A-', 'B+', 'B', 'B', 'B'] },
  { no: 7, rollNo: '1GATM-16', name: 'မောင်လင်းလတ်ညီညီ', marks: ['B+', 'B', 'A-', 'B+', 'A-', 'B+', 'B+', 'B', 'B'] },
  { no: 8, rollNo: '1GATM-8', name: 'မောင်ဇာနည်ခန့်နိုင်', marks: ['B+', 'B+', 'A-', 'B+', 'B+', 'A-', 'B', 'B+', 'B+'] },
  ...
  { no: 14, rollNo: '1GATM-13', name: 'မောင်ဇော်မင်းဦး', marks: ['B+', 'B-', 'A+', 'A-', 'C', 'C', 'B', 'B+', 'B+'] },
  { no: 15, rollNo: '1GATM-5', name: 'မအိမ့်မှူးသူယွယ်', marks: ['B+', 'B', 'B+', 'B+', 'C', 'B+', 'B+', 'B-', 'B-'] },
  { no: 16, rollNo: '1GATM-29', name: 'မောင်ဟဲဗီးဖြိုး', marks: ['B', 'D', 'B+', 'C', 'B', 'B', 'B+', 'B', 'B'] },
  { no: 17, rollNo: '1GATM-20', name: 'မောင်စိုင်းစိုင်းစောဦး', marks: ['B+', 'B-', 'B+', 'Inc', 'B+', 'A-', 'B+', 'B', 'B'] },
  { no: 18, rollNo: '1GATM-10', name: 'မဇူလိုင်ထွန်း', marks: ['A-', 'B', 'A-', 'Inc', 'A-', 'B+', 'B+', 'B-', 'B-'] },
  { no: 19, rollNo: '1GATM-6', name: 'မောင်ဇွဲထက်မာန်', marks: ['B+', 'B+', 'A-', 'A-', 'B+', 'A-', 'Inc', 'Inc', 'B-'] },
  ...
  { no: 22, rollNo: '1GATM-23', name: 'မအိရွှေစင်အောင်', marks: ['B+', 'B+', 'A-', 'Inc', 'Inc', 'B', 'Inc', 'B-', 'B-'] },
  ...
  { no: 29, rollNo: '1GATM-31', name: 'မောင်အောင်စည်သူလင်း', marks: ['B', 'Inc', 'Inc', 'Inc', 'Inc', 'B-', 'B+', 'B+', 'Inc'] },
