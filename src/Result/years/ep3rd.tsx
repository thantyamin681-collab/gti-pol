...
const studentResults: StudentResult[] = [
  ...
  { no: 6, rollNo: '3GEP-6', name: 'မောင်ရဲနန္ဒ', marks: ['B+', 'A-', 'B+', 'A-', 'A-', 'A-'] },
  ...
  { no: 10, rollNo: '3GEP-10', name: 'မောင်စောနိုင်ထွန်း', marks: ['B+', 'B+', 'B', 'B+', 'B+', 'B+'] },
  { no: 11, rollNo: '3GEP-12', name: 'မောင်ဟိန်းထက်နိုင်', marks: ['B', 'B+', 'C', 'B+', 'B+', 'B+'] },
  { no: 12, rollNo: '3GEP-14', name: 'မောင်ခွန်ကောင်မောင်း', marks: ['A-', 'B+', 'B+', 'B+', 'A-', 'A-'] },
