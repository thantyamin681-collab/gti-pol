...
const studentResults: StudentResult[] = [
  ...
  { no: 2, rollNo: '1GEC-7', name: 'မသက်မွန်စိုးအေး', marks: ['A-', 'B+', 'A-', 'A-', 'A', 'A+', 'A', 'A'] },
  { no: 3, rollNo: '1GEC-3', name: 'မသိင်္ဂီကျော်', marks: ['A-', 'A-', 'A', 'A-', 'A', 'A', 'A-', 'A'] },
  { no: 4, rollNo: '1GEC-22', name: 'မယုပန်းဝတီအောင်', marks: ['A-', 'B+', 'A', 'A-', 'A', 'A', 'A-', 'A'] },
  { no: 5, rollNo: '1GEC-15', name: 'မပြုံးအိအိဇင်', marks: ['A-', 'A-', 'A', 'A-', 'A-', 'A-', 'A+', 'A'] },
  { no: 6, rollNo: '1GEC-14', name: 'မသဇင်ထိုက်', marks: ['A-', 'B+', 'B+', 'A-', 'A', 'A', 'A-', 'A+'] },
  { no: 7, rollNo: '1GEC-4', name: 'မောင်ဟိန်းစိုးဝေ', marks: ['A-', 'B+', 'A+', 'B+', 'A', 'A', 'B+', 'A-'] },
  ...
  { no: 10, rollNo: '1GEC-12', name: 'မနှင်းရွှေလင်', marks: ['A-', 'B+', 'A-', 'A-', 'B+', 'A-', 'A-', 'A-'] },
  ...
  { no: 13, rollNo: '1GEC-9', name: 'မသံသာစိုးဦး', marks: ['A-', 'B+', 'A-', 'B+', 'B+', 'A-', 'B+', 'A-'] },
  { no: 14, rollNo: '1GEC-6', name: 'မောင်ဟိန်းထက်ထိုက်စိုး', marks: ['A-', 'B+', 'A-', 'B+', 'A-', 'A', 'C', 'A-'] },
  { no: 15, rollNo: '1GEC-17', name: 'မောင်ခန့်မင်းသန့်', marks: ['B', 'B-', 'B+', 'B+', 'B+', 'A-', 'B+', 'A-'] },
  { no: 16, rollNo: '1GEC-10', name: 'မထူးရတနာနိုင်', marks: ['A-', 'A-', 'B+', 'B', 'B+', 'A-', 'B', 'A-'] },
  { no: 17, rollNo: '1GEC-5', name: 'မောင်သတိထက်ထက်', marks: ['B-', 'B+', 'A-', 'C', 'B+', 'B+', 'D', 'B+'] },
  { no: 18, rollNo: '1GEC-16', name: 'မောင်သီဟသုဇင်ဆင်း', marks: ['B+', 'B+', 'Inc', 'B+', 'B+', 'A-', 'A-', 'B+'] },
  { no: 19, rollNo: '1GEC-19', name: 'မအိမ်လွမ်းသော်', marks: ['A-', 'B', 'A-', 'B+', 'A-', 'A', 'Inc', 'A-'] },
  { no: 20, rollNo: '1GEC-13', name: 'မစန်းချစ်စိုးနွယ်', marks: ['B', 'B+', 'Inc', 'B+', 'C', 'B+', 'B+', 'A-'] },
  { no: 21, rollNo: '1GEC-27', name: 'မောင်သူရိန်မင်းထက်', marks: ['C', 'A-', 'Inc', 'Inc', 'Inc', 'B', 'A-', 'B+'] },
  { no: 22, rollNo: '1GEC-28R', name: 'မောင်ကောင်းမြတ်ဖြိုးထွန်း', marks: ['D', 'D', 'B', 'Inc', 'Inc', 'D', 'D', 'B+'] },
  { no: 23, rollNo: '1GEC-21', name: 'မောင်ဆိုငင်းလင်းထူး', marks: ['B-', 'D', 'Inc', 'Inc', 'Inc', 'D', 'D', 'B+'] },
  { no: 24, rollNo: '1GEC-EX1', name: 'မမွန်နိုဏ်သုဒ္ဓါ', marks: ['F', 'C', 'F', 'Inc', 'Inc', 'Inc', 'F', 'Inc'] }
];
