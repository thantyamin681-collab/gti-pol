...
const yearsList: YearCard[] = [
  { id: '1', yearName: 'First Year', code: 'Year 1', description: 'Basic mechanical engineering principles, workshop technology, applied physics, and mathematics.' },
  { id: '2', yearName: 'Second Year', code: 'Year 2', description: 'Internal combustion engines, automotive electrical systems, chassis, and transmission principles.' },
  { id: '3', yearName: 'Third Year', code: 'Year 3', description: 'Advanced vehicle diagnostics, engine management systems, hybrid & electric vehicles, and automotive control.' },
];

export function AtmPage({ onBack, onSelectYear }: AtmPageProps) {
  ...
  // Year 1 နှိပ်ပါက AtmYear1 ပြသမည်
  if (selectedYear === 'Year 1') {
    return <AtmYear1 onBack={() => setSelectedYear(null)} />;
  }
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <div>
        ...
        <header className="results-header" style={{ width: '100%', borderRadius: 0, margin: 0, padding: '2rem 1rem' }}>
          <div className="results-header-inner" style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
            ...
            <h2>Automotive Technology (ATM) Results</h2>
      ...
      <footer className="results-footer" style={{ width: '100%', borderRadius: 0, margin: 0, marginTop: '3rem' }}>
        ...
        <p className="footer-sub">Automotive Technology Department - Academic Tracking</p>
      </footer>
