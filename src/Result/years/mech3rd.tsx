...
export function MechYear3({ onBack }: MechYear3Props) {
    ...
    <div className="results-wrapper">
      <div className="results-container" style={{ maxWidth: '100%', padding: '2rem 3rem' }}>
        ...
        <div className="results-header">
          <h2>A.G.T.I. (Mechanical Engineering) - Third Year Results</h2>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', minWidth: '1100px' }}>
            <thead>
              <tr style={{ borderBottom: '2px solid #e2e8f0', color: '#64748b', fontSize: '0.8rem' }}>
                ...
                <th style={{ padding: '10px' }}>Fluids Mechanics</th>
                <th style={{ padding: '10px' }}>Design of Machine Elements</th>
                <th style={{ padding: '10px' }}>Refrigeration and Air-conditioning</th>
                <th style={{ padding: '10px' }}>Advanced IC Engine / CNC Machining</th>
