...
const studentResults: StudentResult[] = [
  { no: 1, rollNo: '2GEP-1', name: 'မယမင်းအိန္ဒြာ', marks: ['B+', 'A', 'A', 'A-', 'A-', 'A-', 'B+', 'B+'] },
  ...
  { no: 5, rollNo: '2GEP-5', name: 'မဥမ္မာစိုး', marks: ['B+', 'A', 'A-', 'A-', 'A-', 'B+', 'B+', 'B+'] },
  { no: 6, rollNo: '2GEP-6', name: 'မဆုပြည့်ရတနာ', marks: ['B+', 'A+', 'B+', 'B+', 'B+', 'B+', 'A-', 'B+'] },
  { no: 7, rollNo: '2GEP-7', name: 'မသဇင်နွယ်', marks: ['B+', 'B-', 'A-', 'B+', 'B+', 'B+', 'B+', 'B+'] },
  { no: 8, rollNo: '2GEP-9', name: 'မောင်ဝေထွဋ်အောင်', marks: ['B', 'B+', 'B+', 'B+', 'B+', 'B+', 'B+', 'B+'] },
  { no: 9, rollNo: '2GEP-10', name: 'မောင်ကောင်းထက်', marks: ['B', 'A-', 'B+', 'A-', 'B', 'B+', 'B+', 'B+'] },
  { no: 10, rollNo: '2GEP-12', name: 'မောင်နိုင်ချမ်းအေး', marks: ['B', 'A-', 'B+', 'A-', 'B+', 'B+', 'B+', 'B'] },
  { no: 11, rollNo: '2GEP-16', name: 'မမိုးလဲ့လဲ့ခိုင်', marks: ['D', 'C', 'D', 'B+', 'B', 'B+', 'B-', 'B'] },
  ...
  { no: 19, rollNo: '2GEP-19', name: 'မောင်အောင်လှိုင်ဘွား', marks: ['D', 'B-', 'Inc', 'B+', 'B', 'B', 'Inc', 'C'] },
  ...
  { no: 22, rollNo: '2GEP-22', name: 'မောင်ဟမ်', marks: ['B+', 'B-', 'Inc', 'Inc', 'B+', 'B+', 'Inc', 'B'] },
  { no: 23, rollNo: '2GEP-25', name: 'မောင်ဟိန်းထက်', marks: ['B-', 'B-', 'Inc', 'Inc', 'Inc', 'B+', 'B-', 'C'] },
  { no: 24, rollNo: '2GEP-27', name: 'မောင်နိုင်ရွှီးလိန်း', marks: ['C', 'B-', 'Inc', 'Inc', 'B', 'B', 'Inc', 'B-'] },
  { no: 25, rollNo: '2GEP-24', name: 'မောင်ဟိန်းထက်စံ', marks: ['D', 'C', 'Inc', 'Inc', 'Inc', 'B', 'Inc', 'C'] },
