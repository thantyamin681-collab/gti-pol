...
const studentResults: StudentResult[] = [
  { no: 1, rollNo: '3GEC-1', name: 'မဝင်းသီရိအောင်', marks: ['A', 'A', 'A', 'A', 'A', 'A-'] },
  { no: 2, rollNo: '3GEC-2', name: 'မောင်ဟိန်းထက်', marks: ['A', 'A', 'A-', 'A', 'A', 'A'] },
  { no: 3, rollNo: '3GEC-3', name: 'မမေရီဖြိုး', marks: ['A-', 'A-', 'A-', 'A+', 'A', 'B+'] },
...
export function EcYear3({ onBack }: EcYear3Props) {
    ...
    <div className="results-wrapper">
      <div className="results-container" style={{ maxWidth: '100%', padding: '2rem 3rem' }}>
        ...
        <div className="results-header">
          <h2>A.G.T.I. (Electronic Communications) - Third Year Results</h2>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', minWidth: '1100px' }}>
            <thead>
              <tr style={{ borderBottom: '2px solid #e2e8f0', color: '#64748b', fontSize: '0.8rem' }}>
                ...
                <th style={{ padding: '10px' }}>Electronic Communication Systems II</th>
                <th style={{ padding: '10px' }}>Automation Control Systems II</th>
                <th style={{ padding: '10px' }}>PIC Microcontroller</th>
                <th style={{ padding: '10px' }}>Data Communication and Networking (Elective)</th>
            ...
            <tbody>
              {filteredStudents.length > 0 ? (
                ...
                <tr>
                  <td colSpan={11} style={{ padding: '2rem', color: '#64748b', textAlign: 'center' }}>No student records found.</td>
                </tr>
              )}
            </tbody>
          </table>
