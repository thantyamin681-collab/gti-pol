...
const studentResults: StudentResult[] = [
  ...
  { no: 2, rollNo: '1GC-20', name: 'မစည်သူကို', marks: ['A-', 'A-', 'A+', 'A', 'A', 'A+', 'A', 'A+'] },
  { no: 3, rollNo: '1GC-30', name: 'မခိုင်ထူးမြတ်မွန်', marks: ['A-', 'A-', 'A+', 'A+', 'A', 'A+', 'A', 'A+'] },
  { no: 4, rollNo: '1GC-15', name: 'မခင်မြတ်မာန်', marks: ['A-', 'A-', 'A+', 'A', 'A', 'A+', 'A', 'A+'] },
  { no: 5, rollNo: '1GC-5', name: 'မောင်ရဲရင့်မင်း', marks: ['A-', 'A-', 'A+', 'A', 'A', 'A+', 'A', 'A+'] },
  { no: 6, rollNo: '1GC-8', name: 'မောင်ကောင်းက်ဆက်လင်း', marks: ['A-', 'A-', 'A', 'A', 'A', 'A', 'A', 'A+'] },
  { no: 7, rollNo: '1GC-9', name: 'မောင်ကျော်နိုင်ဝင်း', marks: ['A-', 'B+', 'A+', 'A', 'A', 'A+', 'A', 'A+'] },
  { no: 8, rollNo: '1GC-32', name: 'မဆန်းစိုးမင်း', marks: ['A-', 'A-', 'A+', 'A', 'A-', 'A+', 'A', 'A+'] },
  { no: 9, rollNo: '1GC-6', name: 'မောင်စည်သူကျော်', marks: ['A-', 'A-', 'A', 'A', 'A-', 'A', 'A', 'A+'] },
  { no: 10, rollNo: '1GC-44', name: 'မသဇင်မောင်', marks: ['A-', 'A-', 'A', 'A', 'A-', 'A', 'A', 'A+'] },
  { no: 11, rollNo: '1GC-10', name: 'မောင်ဇေယျာဖြိုး', marks: ['A-', 'B+', 'A', 'A', 'A-', 'A+', 'A', 'A+'] },
  { no: 12, rollNo: '1GC-22', name: 'မောင်မောလဗြိုး', marks: ['A-', 'A-', 'A', 'A', 'A', 'A', 'A-', 'A+'] },
  { no: 13, rollNo: '1GC-29', name: 'မယွန်းမီးမီးထွန်း', marks: ['B+', 'B+', 'A', 'A', 'A-', 'A', 'A', 'A+'] },
  { no: 14, rollNo: '1GC-7', name: 'မောင်ပိုင်ပြည့်ဖြိုးဖြိုး', marks: ['A-', 'A-', 'A+', 'A-', 'A-', 'A', 'A', 'A+'] },
  ...
  { no: 17, rollNo: '1GC-4', name: 'မောင်ဘုန်းရဲကျော်ဟန်', marks: ['B+', 'A-', 'A', 'A-', 'A-', 'A', 'A', 'A+'] },
  { no: 18, rollNo: '1GC-14', name: 'မောင်ထက်ကိုပိုင်လင်း', marks: ['B+', 'B+', 'A-', 'A', 'A-', 'A', 'A', 'A'] },
  { no: 19, rollNo: '1GC-33', name: 'မောင်အားမာန်နန်ထက်', marks: ['A-', 'A-', 'A-', 'A-', 'A-', 'A', 'A', 'A+'] },
  { no: 20, rollNo: '1GC-3', name: 'မသဏ်ဆုသွန်း', marks: ['A-', 'A-', 'A', 'A-', 'B+', 'A', 'A', 'A+'] },
  ...
  { no: 23, rollNo: '1GC-40', name: 'မဝတ်မှုံအေး', marks: ['B+', 'A', 'A-', 'A-', 'B+', 'A', 'A', 'A+'] },
  ...
  { no: 26, rollNo: '1GC-24', name: 'မောင်ငြိမ်းချမ်းမင်းပြီး', marks: ['B+', 'B+', 'A-', 'A-', 'A-', 'B+', 'A-', 'A'] },
  { no: 27, rollNo: '1GC-38', name: 'မဥ္ဇူခင်', marks: ['B+', 'A-', 'A', 'B+', 'B', 'A-', 'A-', 'A'] },
  { no: 28, rollNo: '1GC-21', name: 'စုစန္ဒီဖြိုး', marks: ['B+', 'B', 'A', 'B+', 'B+', 'A-', 'B+', 'A'] },
  { no: 29, rollNo: '1GC-17', name: 'မစူးဇူးနိုင်', marks: ['B+', 'B+', 'B+', 'A-', 'B+', 'B+', 'A-', 'A+'] },
